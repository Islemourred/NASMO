...
const initialMessages = [
  ...
  { id: 4, name: "Fatima Zerhouni", email: "f.zerhouni@example.com", phone: "+213 555 11 22 33", subject: "Partenariat commercial", message: "Nous sommes une entreprise de distribution d'équipements industriels et souhaitons discuter d'un partenariat commercial avec ENTRELEC.", date: "2026-03-06", read: true },
