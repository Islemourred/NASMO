...
export default function DashboardPage() {
  ...
  const statCards = [
    ...
    { label: "Services", val: stats.services.toString(), change: "Services actifs", icon: "M11.42 15.17l-5.1-5.1m0 0L12 4.37m-5.68 5.7h11.36M4.5 12a7.5 7.5 0 1015 0 7.5 7.5 0 00-15 0z", color: "navy-light" },
